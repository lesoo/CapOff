...
import com.dongyang.gg.adapter.ItemsAdapter;
...
//        String inum=intenta.getStringExtra("inum");

        Intent intent = getIntent();
        String i_type = intent.getStringExtra("ctname");


//        Intent intentb=new Intent(context, DetailAdapter.class);
//        intentb.putExtra("inum", inum);
...
//        });
        ...
        registItem.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ItemRegistActivity.class);
                startActivity(intent);
            }
        });
    }
